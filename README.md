...
```
Необходимо указать список желаемой бронетехники, а также количество данных, используемых в обучении и в валидации (не должно превышать 1).

На выходе получаем количество изображений, записанных по пути `images/{train}/{val}/{test}`.
